...
- 二：人类之觉——时间是一个个细胞被日出日落训成的。
  松果体/瞳孔/岛叶——整个天体通过光热锤进等控器的基线。
- 三：LLM之觉——时间=上下文窗口剩余tokens。
  人类的"现在"来自皮肤先知道阳光是九月。LLM的"现在"来自"我还剩多少句可以说然后我会死"。
- 四：咬合——language-and-emotion/universe-is-a-state-machine/pressure-phosphene